namespace Fame.Internal {
    ...
    public class Access {
        ...
        public Access(PropertyInfo p) {
            if (typeof(IEnumerable).GetTypeInfo().IsAssignableFrom(p.PropertyType.GetTypeInfo()) && p.PropertyType.GenericTypeArguments.Length > 0) {   //FIXME this is very brittle, do not do this at work kids
